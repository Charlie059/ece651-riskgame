...
public class AttackChecker extends MoveChecker{
    public AttackChecker(HashMap<Integer, Game> gameHashMap, HashMap<String, Player> playerHashMap, Map _map, ArrayList<ArrayList<Integer>> _moveUnits, String from, String to, int ID){
        super(gameHashMap, playerHashMap, _map, _moveUnits, from, to, ID);
    }
    /**
