...
class PlayerTest {
  ...
  void testPlayerDoMove() throws IOException {
    // wrong from_name/ correct from_name/ wrong level/ correct level/ wrong
    // units#(-1)/
    ...
    bytes.reset();
    System.out.println("From " + testPlayer.getActionList().get(0).getFrom().getName() + " to "
        + testPlayer.getActionList().get(0).getTo().getName() + ", move"
  ...
  void testPlayerDoAttack() throws IOException {
    ...
    bytes.reset();
    System.out.println("From " + testPlayer.getActionList().get(0).getFrom().getName() + " to "
        + testPlayer.getActionList().get(0).getTo().getName() + ", attack"
        + testPlayer.getActionList().get(0).getUnitNumber());
  }
  ...
  void testAttack() {
    ...
    // assertThrows(Exception.class, ()->testPlayer.attack(attackUnits, from_name,
    // to_name));
  }
  ...
  void testPlayerMakeChoice() throws IOException {
    ...
    Player testPlayer = createTextPlayer(select_cmd1 + move_cmd + select_cmd2 + attack_cmd + select_cmd3);
    ...
    for (int i = 0; i < testPlayer.getActionList().size(); i++) {
      ...
      System.out
          .println("From " + a.getFrom().getName() + " to " + a.getTo().getName() + ", units " + a.getUnitNumber());
    }
  }
  ...
  public Player createAttackCheckerPlayer() {
    ...
    Player testPlayer = createTextPlayer(
        select_cmd1 + move_cmd2 + select_cmd2 + attack_cmd + attack_cmd2 + select_cmd3);
    return testPlayer;
  }
  ...
  void testPlayOneRound() throws Exception {
    /*
     * //case 1: lose, but not the first round System.out.
     * println("/////////////////////////////////////case 1: lose, but not the first round////////////////////////////////////"
     * ); Player testPlayer = createEmptyPlayer();
     * testPlayer.setIsFirstRound(false); testPlayer.setIsLose(true);
     * testPlayer.playOneRound(); System.out.println(bytes.toString());
    ...
    System.out
        .println("/////////////////////////////////////case 5: not first round////////////////////////////////////");
  ...
  void testGetter() {
    /**
     * public boolean getIsLose(){return isLose;} public boolean
     * getIsGameOver(){return isGameOver;} public boolean getIsWon(){return isWon;}
