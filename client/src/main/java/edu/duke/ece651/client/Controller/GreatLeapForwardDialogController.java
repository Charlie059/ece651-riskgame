...
public class GreatLeapForwardDialogController implements Initializable,Communication{
        @FXML
        ...
        public GreatLeapForwardDialogController(Stage window, boolean debug){
            this.window = window;
            this.debug = debug;
