...
public class Player {
                ...
                do {
                    ...
                    try {
                        ...
                        if (totalDeployment.get(level) >= unitNum && unitNum >= 0) {
                            ...
                            out.println("Deployment Error: Number of level-" + level + " units cannot be less than o or exceed the total " +
    ...
    public void playerDoAttack(BufferedReader inputReader, PrintStream out) throws IOException{
        ...
        do{
            ...
            do {
                ...
                if (isToValid == false){
                    out.println("Attack Error: Territory name "+"\""+to_name+ "\""+ " not found! Please enter a valid name!");
                }
            } while(!isToValid);
     ...
     * player should make a new attack command if the current attack is invalid
     * @param attackUnits
     * @param from_name
     * @param to_name
     * @param wholeMap
     ...
     * @return
     */
    public boolean checkAttack(HashMap<Integer, Integer>attackUnits,
    ...
    /**
     * check if player loses all her territories
     * if so, set isLose as true
     * @return
     */
     ...
     * A player wins when she controls all territories in the game.
     * @return
     */
    ...
    /**
     * if all territories in map are controlled by one player, set isGameOver = true;
     * @return
     */
