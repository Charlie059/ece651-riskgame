...
import edu.duke.ece651.client.Controller.MoveDialogController;
...
public class MoveDialogView implements View {
    ...
    public void show(Stage window, Model model, boolean debug) throws IOException {
        ...
        URL xmlResource = getClass().getResource("/xml/moveDialogView.fxml");
