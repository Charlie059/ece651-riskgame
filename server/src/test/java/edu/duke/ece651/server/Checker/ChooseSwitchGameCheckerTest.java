...
class ChooseSwitchGameCheckerTest {
    //Game.java
    ...
    private void createGame() {
        ...
        game3.getPlayerHashMap().put(new AccountID("Eric"),eric);
        gameHashMap.put(new GameID(1),game);
        gameHashMap.put(new GameID(3),game3);
        //set Territory
    ...
    void doCheck() {
        ...
        ChooseSwitchGameChecker chooseSwitchGameChecker= new ChooseSwitchGameChecker(
                 gameHashMap,
                 accountHashMap,
                drewAccount,
                 new GameID(1)
        );
        assertEquals(null, chooseSwitchGameChecker.doCheck());

        chooseSwitchGameChecker= new ChooseSwitchGameChecker(
                gameHashMap,
                accountHashMap,
                drewAccount,
                new GameID(2)
        );
        assertEquals("ChooseSwitchGame Error: game ID does not exist!", chooseSwitchGameChecker.doCheck());
        ...
        assertEquals("ChooseSwitchGame Error: game ID does not match!", chooseSwitchGameChecker.doCheck());
//        System.out.println(chooseSwitchGameChecker.doCheck());
