...
class GodBeWithUCheckerTest {
    ...
    void doCheck() {
        ...
        String errMessage = godBeWithUChecker.doCheck();
        assertEquals("GodBeWithYou Error: player does have any GodBeWithYou Card!", errMessage);

        drew.addCard(15);
        errMessage = godBeWithUChecker.doCheck();
