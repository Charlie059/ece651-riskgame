...
class CardBuyCheckerTest {
    ...
    void doCheck() {
        ...
        String errMessage = cardBuyChecker.doCheck();
        assertEquals("CardBuy Error: player does not have enough points!", errMessage);

        drew.setPoints(1000);
        cardBuyChecker = new CardBuyChecker(
                this.gameHashMap,
                this.accountHashMap,
                drewAccount,
                drew,
        ...
        errMessage = cardBuyChecker.doCheck();
